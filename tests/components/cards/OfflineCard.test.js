...
describe('OfflineCard', () => {
  ...
  describe('Rendering', () => {
    test('renders the component with correct title and subtitle', () => {
      ...
      expect(
        screen.getByText('Challenge yourself in offline mode')
      ).toBeInTheDocument();
    });
    ...
    test('renders both game option switches', () => {
      ...
      expect(
        screen.getByText('Pieces become invisible after placement')
      ).toBeInTheDocument();
      expect(screen.getByText('Increased Gravity')).toBeInTheDocument();
      expect(
        screen.getByText('Pieces fall faster for extra challenge')
      ).toBeInTheDocument();
