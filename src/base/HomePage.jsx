  ...
  return (
    <div className={`${styles.content} flex flex-col h-full`}>
      ...
      <div className={`${styles.grid} container grid mx-auto grid-cols-3 row-span-10 gap-8 flex-1 pt-8 pb-1 w-full`}>
        <div className={`${styles.userCardContainer} grid grid-rows-8 gap-4`}>
          <Card className={`row-span-3`}>
            <UserCard />
          </Card>
          <Card className={`${styles.historyCard} row-span-5 flex flex-col min-h-0`}>
            <MatchHistory />
          </Card>
        </div>
        ...
        <Card isUsernameRequired={true} greyScale={error} message="Multiplayer not available" loading={isLoading}>
          <OnlineCard />
        </Card>
      </div>
    </div>
