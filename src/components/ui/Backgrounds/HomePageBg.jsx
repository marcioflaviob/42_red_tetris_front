...
const PIECE_COUNT = 10; // Increased for better screen coverage
const ROW_COUNT = 3;
...
const Row = ({ pieces, speed }) => {
    ...
    return (
        <div className={styles.row} ref={containerRef}>
            {renderPieces()}
            {renderPieces()} {/* Render the same pieces again for a seamless loop */}
        </div>
    );
};

const HomePageBg = () => {
    // Generate random pieces for each row
